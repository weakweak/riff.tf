...
**Last updated: Wednesday, 21st June 2017 - Updated rotation**
...
- Symbols of Death and Death from Above, should be lined up with 1 charge of
  Dance Dance
...
There aren't any hard requirements for AddOns you should use.

You should look into using Weak Auras and/or an energy bar AddOn. I do not share
the AddOns that I specifically wrote myself for Subtlety Rogue as I get
inundated with people asking to add their feature, or fix a bugs that don't
affect me.
...
TODO: update links to my auras, including new ones.
